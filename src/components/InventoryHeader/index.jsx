...
// import Inventorybanner from "../../icons/inventory-banner.svg"
          ...
          <div className="order-2 lg:order-1 px-8">
            <div className="space-y-4">
              ...
              <div className="heading-text">
                    <h2 className="text-[64px] w-[495px] leading-20 text-black font-bold mb-4">Inventory Software for your industry.</h2>
                    <p className="text-lg text-[32px] text-[#666666] font-bold">You and your construction crew should be working-not searching for supplies or hurting down missing materials. With Sortly’s construction inventory software.</p>
                </div>
