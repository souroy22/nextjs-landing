...
const SectionHalfRrectangleLeft = () => {
  return (
    <div className="relative flex flex-col lg:flex-row justify-between items-center min-h-screen px-6 py-10">
      ...
      <div className="w-full lg:w-2/3 flex justify-center mb-6 lg:mb-0 relative">
        <div className="absolute inset-0 -left-8 -top-24 bg-[url('/RectangleLeft.png')] bg-no-repeat bg-center bg-[length:100%] w-[80%] h-[129%]"></div>
        <Image
...
export default SectionHalfRrectangleLeft;
